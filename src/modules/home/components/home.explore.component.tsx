...
const HomeExplore = () => {
  ...
  return (
    <Box textAlign={"center"} py="44px">
      <Text fontSize={{ base: "30px", sm: "36px" }} fontWeight={"bold"} color="purple.500">
      ...
      >
        {explore.map((item) => (
          <Box mx={{ base: "44px", sm: "0px" }} key={item.id} shadow="md" borderRadius={"md"}>
            <Box
              w="100%"
              h={{ sm: "150px", md: "200px" }}
              ...
              py="25px"
            >
              <Image boxSize="100%" objectFit="cover" src={item.img} alt="Banner" />
            </Box>
            <Text fontSize={{ base: "16px", md: "22px" }} fontWeight="bold" color={"#222430"}>
              {item.title}
            </Text>
